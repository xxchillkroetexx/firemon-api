...
class NetworkAccessPath(BaseRecord):
    """NetworkAccessPath"""
    ...
    def __init__(
        ...
        config: dict,
        app: App,
        device_group_id: Optional[int] = 1,
        apa_request: dict = {},
    ):
        self._device_group_id = device_group_id
        self._apa_request = apa_request
        super().__init__(config, app)
        self._ep_url = f"{self._domain_url}/devicegroup/{self._device_group_id}/apa"
        self._url = self._ep_url
